...
class expirationDate_Tracker:
    ...
    def remove_Product(self, name):
        self.products[name][0] = self.products[name][0]
...
s = expirationDate_Tracker(time.time())
s.add_prod('Banana')
s.add_expiration_date('Banana', "11 Aug 2022")

s.add_prod('Orange')
s.add_expiration_date('Orange', "12 Aug 2022")

s.add_prod('Kiwi')
s.add_expiration_date('Kiwi', "13 Aug 2022")

s.add_prod('Apple')
s.add_expiration_date('Apple', "14 Aug 2022")

s.add_prod('Peach')
s.add_expiration_date('Peach', "15 Aug 2022")


s.remove_Product('Banana')
s.remove_Product('Orange')
s.remove_Product('Kiwi')
s.remove_Product('Apple')
s.remove_Product('Peach')
